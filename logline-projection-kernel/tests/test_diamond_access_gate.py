...
class TestDiamondAccessGate(unittest.TestCase):
    ...
    def test_request_access(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            gate = DiamondAccessGate(nas_root=tmp, receipts=NullReceipts())
            request = AccessRequest(
                actor=AccessActor(actor_id="x", roles=["operator"]),
                mode="read",
                purpose="test",
                reason="testing",
            )
