"""Example: test whether a projection is sealable."""
...
def main():
    ...
    context = {
        ...
        "custody_policy": {
            "exists": True,
            "vault": "nas:minivault",
            "path": os.path.join(nas_root, "Minivault"),
        },
        "revocation": {
            "exists": True,
    ...
    print("sealable", result.sealable)
    print("report_status", result.report_status)
