...
- Prefixed internal references (`lens:`, `seal-context:`, `anchor-package:`,
  `diamond-manifest:` …) across the engines and diamond modules. These are
  engine-internal object references, not canon Acts/Receipts, but they should
  eventually either become canon objects with bare content-hash ids or be
  explicitly declared out of canon scope.
